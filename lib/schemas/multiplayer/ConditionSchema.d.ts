...
export declare type ConditionSchema = ConditionCheckSchema | ConditionComparisonSchema | ConditionIsRoleSchema | ConditionTimePassedSchema | ConditionTimeRangeSchema | ConditionLogicalSchema | ConditionLocationSchema;
